...
function Karmix:CreateWindow(settings)
    ...
    function window:CreateTab(tabSettings)
        ...
        function tabObj:CreateToggle(opt)
            ...
            local callback = opt.Callback or function(state) end
        ...
        function tabObj:CreateSlider(opt)
            ...
            local precision = opt.Precision or 1
            local callback = opt.Callback or function(val) end
            local frame = createInstance("Frame", {
        ...
        function tabObj:CreateColorPicker(opt)
            ...
            local callback = opt.Callback or function(color) end
            local frame = createInstance("Frame", {
